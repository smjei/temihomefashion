"""
Django settings for temifashion project.
...
SECRET_KEY = 'django-insecure-uipd$j(tq$x5^*dls*4$g_ih*v$#ltc6yj0_mpn$bcvj4&n*o0'
...
WSGI_APPLICATION = 'temifashion.wsgi.application'
